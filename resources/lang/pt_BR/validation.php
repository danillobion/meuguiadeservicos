...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir contêm as mensagens de erro padrão usadas pelo
    | validador. Algumas dessas regras possuem várias versões, como as
